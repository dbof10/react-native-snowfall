...
class SnowFlake {
  ...
  private SnowFlake(Random random, Point position, float angle, float increment, float flakeSize,
      Paint paint) {
    this.random = random;
  ...
  static SnowFlake create(int width, int height, Paint paint) {
  ...
  private void move(int width, int height) {
    ...
    Log.d(TAG, "move() called with: width = [" + x + "], height = [" + y + "]"
    + "rounded: x : " + (int)x + " y : " + (int)y);
